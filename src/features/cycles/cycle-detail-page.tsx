...
export const CycleDetailPage = () => {
  ...
  return (
    <div className="space-y-6">
      <PageSection title={t('redirect.cycleDetailTitle')} subtitle={t('redirect.cycleDetailDesc')}>
        <div className="max-w-2xl space-y-4">
          <p className="text-sm leading-6 text-[var(--color-text-muted)]">{t('redirect.cycleDetailBody')}</p>
          <Link
            to="/ponds"
